...
final class IdleThresholdSettingsTests: XCTestCase {
    ...
    func testSubagentCleanupDefault() {
        ...
        XCTAssertEqual(SettingsDefaults.subagentCleanupSeconds, 0)
    }
    ...
    func testTranscriptStaleNoToolDefault() {
        ...
        XCTAssertEqual(SettingsDefaults.transcriptStaleNoToolSeconds, 0)
    }
    ...
    func testTranscriptStaleWithToolDefault() {
        ...
        XCTAssertEqual(SettingsDefaults.transcriptStaleWithToolSeconds, 0)
    }
