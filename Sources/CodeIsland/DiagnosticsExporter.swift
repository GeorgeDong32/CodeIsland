    ...
    private static func metadata() -> [String: Any] {
        [
            ...
            "settings": [
                ...
                "subagentCleanupSeconds": UserDefaults.standard.integer(forKey: SettingsKey.subagentCleanupSeconds),
                "transcriptStaleNoToolSeconds": UserDefaults.standard.integer(forKey: SettingsKey.transcriptStaleNoToolSeconds),
                "transcriptStaleWithToolSeconds": UserDefaults.standard.integer(forKey: SettingsKey.transcriptStaleWithToolSeconds),
