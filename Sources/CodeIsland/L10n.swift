...
final class L10n: ObservableObject {
    ...
    private static let en: [String: String] = [
        ...
        "long_press_to_disable": "Long press to disable",
        "long_press_auto_approve_tooltip": "Long press 2s to enable auto approve all",
    ...
    private static let zh: [String: String] = [
        ...
        "long_press_to_disable": "长按关闭",
        "long_press_auto_approve_tooltip": "长按 2 秒开启自动批准全部",
        "type_answer": "输入回答…",
        "skip": "跳过",
        "back": "返回",
        "confirm": "确认",
    ...
    private static let ja: [String: String] = [
        ...
        "long_press_to_disable": "長押しで解除",
        "long_press_auto_approve_tooltip": "長押し 2 秒で自動承認を有効化",
    ...
    private static let ko: [String: String] = [
        ...
        "long_press_to_disable": "길게 눌러 비활성화",
        "long_press_auto_approve_tooltip": "길게 눌러 2초 후 모든 권한 자동 승인 활성화",
    ...
    private static let tr: [String: String] = [
        ...
        "long_press_to_disable": "Devre dışı bırakmak için uzun basın",
        "long_press_auto_approve_tooltip": "2 saniye uzun basarak tüm izinleri otomatik onayla",
